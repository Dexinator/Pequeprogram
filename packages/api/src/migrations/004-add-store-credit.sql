...
COMMENT ON COLUMN valuation_items.store_credit_price IS 'Precio para modalidad crédito en tienda (20% más que compra directa)';
...
SET store_credit_price = ROUND(suggested_purchase_price * 1.2, 2) 
